import { Mesh, RawShaderMaterial, BufferGeometry, MeshStandardMaterial, Scene, WebGLRenderer, BufferAttribute, MeshBasicMaterial, Color, Vector4 } from "mozilla-three";
