...
const mozilla_three_1 = require("mozilla-three");
...
class UnlitBatch extends mozilla_three_1.Mesh {
    constructor(ubo, atlas, options = {}) {
        ...
        const geometry = new mozilla_three_1.BufferGeometry();
        geometry.setAttribute("instance", new mozilla_three_1.Float32BufferAttribute(new Float32Array(opts.bufferSize), 1));
        geometry.setAttribute("position", new mozilla_three_1.Float32BufferAttribute(new Float32Array(opts.bufferSize * 3), 3));
        if (opts.enableVertexColors) {
            geometry.setAttribute("color", new mozilla_three_1.Float32BufferAttribute(new Float32Array(opts.bufferSize * 3).fill(1), 3));
        }
        geometry.setAttribute("uv", new mozilla_three_1.Float32BufferAttribute(new Float32Array(opts.bufferSize * 2), 2));
        geometry.setIndex(new mozilla_three_1.Uint32BufferAttribute(new Uint32Array(opts.bufferSize), 1));
        geometry.setDrawRange(0, 0);
        const material = new mozilla_three_1.RawShaderMaterial({
...
class BatchManager {
    constructor(scene, renderer, options = {}) {
        ...
        this.fogOptions = new mozilla_three_1.Vector4();
        this.fogColor = new mozilla_three_1.Color();
        this.sharedUniforms = {
