...
const WrapModes = {
    [mozilla_three_1.ClampToEdgeWrapping]: 0,
    [mozilla_three_1.RepeatWrapping]: 1,
    [mozilla_three_1.MirroredRepeatWrapping]: 2
};
const DEFAULT_COLOR = new mozilla_three_1.Color(1, 1, 1);
const HIDE_MATRIX = new mozilla_three_1.Matrix4().makeScale(0, 0, 0);
const tempUvTransform = [0, 0, 0, 0];
class BatchRawUniformGroup extends mozilla_three_1.RawUniformsGroup {
    ...
    addMesh(mesh, atlas) {
        ...
        if (material.map) {
            ...
            this.setInstanceMapSettings(instanceId, atlas.nullTextureIndex[0], mozilla_three_1.ClampToEdgeWrapping, mozilla_three_1.ClampToEdgeWrapping);
        }
